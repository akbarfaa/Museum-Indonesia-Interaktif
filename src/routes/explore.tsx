  ...
  head: () => ({
    meta: [
      { title: "Explore Indonesia — NusantaraVerse" },
      {
        name: "description",
        content:
          "An interactive map of Indonesia's provinces — tap any glowing region to enter a cultural world.",
      },
    ],
  }),
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <div className="mt-4 inline-flex items-center gap-2 text-xs uppercase tracking-widest text-gold">
            ...
            {visited.length}/{PROVINCES.length} {t("explore.visited")}
          </div>
        </motion.div>
        ...
        <motion.p
          ...
          className="mt-4 text-center text-xs text-ivory/40 uppercase tracking-widest"
        >
          Click any highlighted province to explore its culture
        </motion.p>
          ...
          {PROVINCES.map((p) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="text-[11px] uppercase tracking-wider text-ivory/50">
                  {pick(p.region, lang)}
                </div>
              </div>
            </Link>
